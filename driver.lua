...
if hash or SudoBot(msg) or DevdriverW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevdriverW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevdriverW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevdriverW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevdriverW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevdriverW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevdriverW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
driver_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
driver_Msg = 'رب التفاعل'  
end 
return driver_Msg 
end
...
--------
function Sourcedriver(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'درايفر')
Sourcedriverr = '*⌯︙اهلا عزيزي*\n*⌯︙انا بوت اسمي '..Namot..'*\n*⌯︙اختصاصي حمايه الكروبات*\n*⌯︙من تكرار والسبام والتوجيه والخ…*\n*⌯︙لتفعيلي اتبع الاخطوات…↓*\n*⌯︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع -›{ منشئ او المشرفين } بتفعيل فقط*\n⌯︙[قناة سورس البوت](http://t.me/Vc33h)'
end
send(msg.chat_id_, msg.id_, Sourcedriverr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevdriverW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevdriverW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌯' and DevdriverW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevdriverW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevdriverW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevdriverW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevdriverW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevdriverW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevdriverW(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/DriVeR-tel/DriVeR/main/driver.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس درايفر*\n*⌯︙الاصدار -› { 2.8v}*')
dofile('driver.lua')  
end
if text == 'الاصدار ⌯' and DevdriverW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس درايفر* \n*⌯︙الاصدار -›{ 2.8v}*')
end
if text == "ضع اسم للبوت ⌯" and DevdriverW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevdriverW(msg) then 
...
if text == 'المشتركين ⌯' and DevdriverW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين-› {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevdriverW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات-› {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevdriverW(msg) then
...
if text == ("قائمه العام ⌯") and DevdriverW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevdriverW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevdriverW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevdriverW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevdriverW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevdriverW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevdriverW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevdriverW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevdriverW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌯" and DevdriverW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان -› { '..#group..' }'..driverk..''..driver..'*\n*⌯︙الان عدد الكروبات الحقيقي -› { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevdriverW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevdriverW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevdriverW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevdriverW(msg) then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevdriverW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevdriverW(msg) then
...
if text and text:match("^تغير رساله الاشتراك$") and DevdriverW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevdriverW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevdriverW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevdriverW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevdriverW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevdriverW(msg) then  
...
if t2.id_ then 
name_driver = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_driver then 
names_driver = database:smembers(bot_id.."driver:blocname"..msg.chat_id_) or ""
if names_driver and names_driver[1] then 
for i=1,#names_driver do 
if name_driver:match("(.*)("..names_driver[i]..")(.*)") then 
...
function amir_drivera_new(driver1,driver2)
if driver2 and driver2.first_name_ then 
if driver2.first_name_:match("(.*)"..database:get(bot_id.."driver:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."driver:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local driver_nnn = database:get(bot_id.."driver:nump"..msg.chat_id_) or 5
local driver_nnn2 = database:get(bot_id.."driver:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(driver_nnn2) == tonumber(driver_nnn) or tonumber(driver_nnn2) > tonumber(driver_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."driver:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..driver2.username_.."](https://t.me/"..(driver2.username_ or "Vc33h")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."driver:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(driver_nnn) - tonumber(driver_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_drivera_new)
end
end
...
Text = [[
*أهلاً بك في السوࢪس* [𝘋𝘳𝘪𝘝𝘦𝘙 𝘴𝘰𝘳𝘶𝘤𝘦💘]
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس 💘',url="https://t.me/Vc33h"},
},
{
{text = 'مطوࢪ السوࢪس 💘',url="t.me/H_4_L"},
},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevdriverW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Vc33h')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Vc33h')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
---- -----------------
if text == 'تحديث' and DevdriverW(msg) then
dofile('driver.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevdriverW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevdriverW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if driverSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevdriverW(msg) then
...
if driverSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevdriverW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevdriverW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevdriverW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevdriverW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevdriverW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevdriverW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevdriverW(msg) then
...
---- -----------------
if text == ("مسح المطورين") and DevdriverW(msg) then
...
if text == 'الملفات' and DevdriverW(msg) then
t = ' *⌯︙ملفات السورس درايفر ↓*\n*•━━━━━━ 𝘋𝘳 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات درايفر*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝘋𝘳 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝘋𝘳 ━━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس درايفر ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/Vc33h) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevdriverW(msg) then
...
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس درايفر* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevdriverW(msg) then
...
if text == "مسح الملفات" and DevdriverW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevdriverW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevdriverW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو -›* ['..data.first_name_..'](t.me/'..(data.username_ or 'Vc33h')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو -›* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو -›* ['..data.first_name_..'](t.me/'..(data.username_ or 'Vc33h')..')'
...
if text == 'مسح كليشه المطور' and DevdriverW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevdriverW(msg) then
...
if text == 'تفعيل الاذاعه' and DevdriverW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevdriverW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'درايفر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'درايفر')
local driver_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
if database:get(bot_id..'Bc:Bots') and not DevdriverW(msg) then 
...
if driverSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevdriverW(msg) then 
...
if text == ("ردود المطور") and DevdriverW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝘋𝘳 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevdriverW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevdriverW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'درايفر').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevdriverW(msg) then   
...
if text == 'تعطيل المغادره' and DevdriverW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'driver')..') '
...
-- vardump(data) 
driverdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة -› ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه -› ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين -› ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء -› ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevdriverW(msg) then
...
zh = https.request('https://vvvzvv.ml/amirZhfa/driver.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝘋𝘳 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ 𝘋𝘳 ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[𝘋𝘳𝘪𝘝𝘦𝘙 𝘴𝘰𝘳𝘶𝘤𝘦](t.me/Vc33h) ')
end
...
gk = https.request('https://vvvzvv.ml/amirBrg/driver.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/driver.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘋𝘳𝘪𝘝𝘦𝘙 𝘴𝘰𝘳𝘶𝘤𝘦.',url="t.me/Vc33h"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'درايفر')
