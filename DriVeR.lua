...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRCDriVeR/Files_DriVeR/main/File_Bot/commands.lua") 
...
function DevHaDr(msg) 
local hash = database:sismember(bot_id.."Dev:HaDr:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevHaDr(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevHaDr(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevHaDr(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevHaDr(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevHaDr(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevHaDr(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevHaDr(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:HaDr:2", user_id) then
var = true  
...
local DriVeR_Msg = ''  
if msgs < 100 then 
DriVeR_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
DriVeR_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
DriVeR_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
DriVeR_Msg = 'متفاعل' 
elseif msgs < 1200 then 
DriVeR_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
DriVeR_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
DriVeR_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
DriVeR_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
DriVeR_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
DriVeR_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
DriVeR_Msg = 'ملك التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"- TeAM Source DriVeR.")  
...
function plugin_DriVeR(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.DriVeR and msg then
pre_msg = plugin.DriVeR(msg)
end
end
end
...
function SourceDriVeR(msg,data)
if msg then
...
local url,res = https.request('https://anashtick.ml/DriVeR.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.DriVeR ~= true then
local inline = {{{text="اضغط هنا للشتراك 🚹",url="https://t.me/Vc33h"}}}
SendInline(msg.chat_id_,'عذراً عليك الاشتراك في [. Team DriVeR](t.me/Vc33h) \nليمكنك استخدام البوت بشكل كامل',nil,inline)
return false 
end
...
if DevHaDr(msg) then
local bl = '👋🏻꒐ أهلاً بك ، [المطور الاساسي .](t.me/Vc33h)\n🔽꒐ اليك قسم الكيبورد للاذاعة '
local keyboard = {
{'اذاعه بالتثبيت 📥'},
{'اذاعه عام 🚻','اذاعه خاص 📨'},
...
Text = '👋🏻꒐ اهلا بك في بوت حماية المجموعات\n⏺꒐ يمكنك اضافتي الى مجموعتك [وتفعيلي .](t.me/Vc33h)\n⎯ ⎯ ⎯ ⎯'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '💭꒐ معرفة المزيد ؟',url="t.me/Vc33h"},
},
}
...
if not DevHaDr(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevHaDr(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,DriVeR_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⚡' and DevHaDr(msg) then  
...
if text == 'تعطيل التواصل 🔰' and DevHaDr(msg) then  
...
if text == 'تفعيل البوت الخدمي 🔖' and DevHaDr(msg) then  
...
if text == 'تعطيل البوت الخدمي 📛' and DevHaDr(msg) then  
...
if text == 'ضع كليشة ستارت ⌨️' and DevHaDr(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'↪️꒐ ارسل لي الكليشه الان')
return false
end
if text == 'حذف الستارت 📧' and DevHaDr(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'🚮꒐ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر 🗃️' and DevHaDr(msg) then 
...
if text == 'تحديث السورس ✅' and DevHaDr(msg) then 
os.execute('rm -rf DriVeR.lua')
os.execute('https://raw.githubusercontent.com/DriVeR-tel/DriVeR/main/DriVeR.lua')
send(msg.chat_id_,msg.id_,'📊꒐تم التحديث')
dofile('DriVeR.lua')  
end
if text == 'الاصدار 📃' and DevHaDr(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'◀️꒐ اصدار سورس درايفرلديك (*v1.0*) 🛡️')
end
if text == "تغير اسم البوت 🔁" and DevHaDr(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"↪️꒐ حسناً ارسل اسم البوت")
return false
end
if text == 'الاحصائيات 📊' and DevHaDr(msg) then 
...
if text == ("المطورين 🛡️") and DevHaDr(msg) then
...
if text == ("الثانويين 🚹") and DevHaDr(msg) then
local list = database:smembers(bot_id.."Dev:HaDr:2")
...
if text == ("مسح الثانويين 🚮") and DevHaDr(msg) then
database:del(bot_id.."Dev:HaDr:2")
send(msg.chat_id_, msg.id_, "\n✅꒐ تم مسح قائمة المطورين الثانويين  ")
end
if text == ("قائمه العام 🚯") and DevHaDr(msg) then
...
if text=="اذاعه خاص 📨" and msg.reply_to_message_id_ == 0 and DevHaDr(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↪️꒐ ارسل الان اذاعتك؟ \n📌꒐ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه عام 🚻" and msg.reply_to_message_id_ == 0 and DevHaDr(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↪️꒐ ارسل الان اذاعتك؟ \n📌꒐ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت 📥" and msg.reply_to_message_id_ == 0 and DevHaDr(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↪️꒐ ارسل الان اذاعتك؟ \n📌꒐ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه 📩" and msg.reply_to_message_id_ == 0  and DevHaDr(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"↪️꒐ ارسل لي التوجيه الان")
return false
end 
if text=="توجيه خاص 🗳️" and msg.reply_to_message_id_ == 0  and DevHaDr(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"↪️꒐ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 🗂️' and DevHaDr(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ℹ️" and DevHaDr(msg) then 
...
if text == "تنظيف المجموعات 🖇️" and DevHaDr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'📊꒐ عدد المجموعات الان -› { '..#group..' }'..DriVeRk..''..DriVeR..'\n🔢꒐ عدد المجموعات الحقيقي -› { '..sendok..' } مجموعة\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevHaDr(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevHaDr(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevHaDr(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevHaDr(msg) then
...
local DriVeR1_Msg = database:get(bot_id.."DriVeR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DriVeR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🚹꒐ العضو :  ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Vc33h')..') \n▶️꒐ '..DriVeR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DriVeR_Msg and not Special(msg) then  
local DriVeR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DriVeR_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"🚹꒐ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n▶️꒐ ["..DriVeR_Msg.."] \n")
else
send(msg.chat_id_,0,"🚹꒐ العضو : {["..data.first_name_.."](T.ME/Vc33h)}\n▶️꒐ ["..DriVeR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "🚹꒐ عذرا -› {["..data.first_name_.."](T.ME/Vc33h)}\n⛔꒐ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard.inline_keyboard = {
{
{text = '⏺️꒐ معرفة المزيد ؟',url="https://t.me/Vc33h"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevHaDr(msg) then
...
if text and text:match("^تغير الاشتراك 🏷️$") and DevHaDr(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '↪️꒐ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك 🗞️$") and DevHaDr(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '↪️꒐ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✂️" and DevHaDr(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "🚮꒐ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ➗$") and DevHaDr(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '↪️꒐ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك 🔔" and DevHaDr(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك 🚫" and DevHaDr(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "❎꒐ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 💈" and DevHaDr(msg) then  
...
database:sadd(bot_id.."DriVeR:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DriVeR:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_MRHaDr = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRHaDr then 
names_MRHaDr = database:smembers(bot_id.."DriVeR:blocname"..msg.chat_id_) or ""
if names_MRHaDr and names_MRHaDr[1] then 
for i=1,#names_MRHaDr do 
if name_MRHaDr:match("(.*)("..names_MRHaDr[i]..")(.*)") then 
...
database:set(bot_id.."DriVeR:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DriVeR:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DriVeR:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DriVeR:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DriVeR:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function HaDr_mrHaDr_new(mrHaDr1,mrHaDr2)
if mrHaDr2 and mrHaDr2.first_name_ then 
if mrHaDr2.first_name_:match("(.*)"..database:get(bot_id.."DriVeR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DriVeR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrHaDr_nnn = database:get(bot_id.."DriVeR:nump"..msg.chat_id_) or 5
local mrHaDr_nnn2 = database:get(bot_id.."DriVeR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrHaDr_nnn2) == tonumber(mrHaDr_nnn) or tonumber(mrHaDr_nnn2) > tonumber(mrHaDr_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DriVeR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "🚹꒐ عزيزي >>["..mrHaDr2.username_.."](https://t.me/"..(mrHaDr2.username_ or "Vc33h")..")\n▶️꒐ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DriVeR:teh"..msg.chat_id_).."} بجانب اسمك\n🔢꒐ عدد المحاولات المتبقيه {"..(tonumber(mrHaDr_nnn) - tonumber(mrHaDr_nnn2)).."}")
end
end
end
end
bnnaGet(id, HaDr_mrHaDr_new)
end
end
...
local DriVeRChengName = database:get(bot_id.."DriVeR:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DriVeRChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DriVeRChengName..']')
database:del(bot_id.."DriVeR:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DriVeRChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."DriVeR:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DriVeRChengUserName = database:get(bot_id.."DriVeR:Cheng:UserName"..data.id_)
if not data.username_ then 
if DriVeRChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DriVeRChengUserName..']')
database:del(bot_id.."DriVeR:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DriVeRChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DriVeR:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DriVeRChengPhoto = database:get(bot_id.."DriVeR:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DriVeRChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DriVeR:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DriVeRChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DriVeR:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = [[
*أهلاً بك في سورس* [DRIVER 🔽](t.me/Vc33h)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناة السورس 📢',url="https://t.me/Vc33h"},
},
{
{text = 'تواصل السورس 💭',url="t.me/Z_A_XBOT"},
},
{
{text = 'مطور السورس 📑',url="t.me/H_4_L"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'رفع نسخه الاحتياطيه' and DevHaDr(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'جلب نسخه الاحتياطيه' and DevHaDr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'◀️꒐ بواسطه ⌁  ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Vc33h')..') \n❎꒐ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'◀️꒐ بواسطه ⌁  ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Vc33h')..') \n❎꒐ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevHaDr(msg) then    
dofile('DriVeR.lua')  
send(msg.chat_id_, msg.id_, '☑️꒐ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevHaDr(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevHaDr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevHaDr(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevHaDr(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevHaDr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevHaDr(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevHaDr(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevHaDr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevHaDr(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevHaDr(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevHaDr(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n🚮꒐ تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevHaDr(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n📋꒐ قائمة مطورين البوت \nٴ — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,HaDr)
x = 0
tags = 0
local list = HaDr.members_
for k, v in pairs(list) do
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevHaDr(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevHaDr(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:HaDr'..msg.chat_id_) then
Text = '✅꒐ تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:HaDr'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:HaDr'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:HaDr'..msg.chat_id_,true)  
Text = '\n❎꒐ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:HaDr'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-DriVeR")
...
function Function_DriVeR(extra, result, success)
database:sadd(bot_id.."Dev:HaDr:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","⏫꒐ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DriVeR, nil)
return false 
end
...
function Function_DriVeR(extra, result, success)
database:srem(bot_id.."Dev:HaDr:2", result.sender_user_id_)
...
function Function_DriVeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:HaDr:2", result.id_)
...
database:srem(bot_id.."Dev:HaDr:2", userid)
...
database:set(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"♨️꒐ تم حفظ الكلمه الممنوعة \n🔽꒐ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DriVeR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DriVeR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"✅꒐ تم منع الكلمه مع التحذير")  
database:del(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DriVeR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DriVeR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DriVeR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"↪️꒐ ارسل الكلمه لمنعها الان")  
database:set(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DriVeR1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DriVeR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DriVeR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DriVeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DriVeR1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DriVeR1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n📋꒐ قائمة المنع \nٴ — — — — — — — — — \n"
for k,v in pairs(list) do  
local DriVeR_Msg = database:get(bot_id.."DriVeR1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." -› {"..DriVeR_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevHaDr(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'✅꒐ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevHaDr(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n🚹꒐ العضو :  ['..result.title_..'](t.me/'..(text1[3] or 'Vc33h')..')'..'\n⏫꒐ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevHaDr(msg) then  
...
if text == 'تعطيل الاذاعه' and DevHaDr(msg) then  
...
send(msg.chat_id_, msg.id_,'['..DriVeR_Msg[math.random(#DriVeR_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevHaDr(msg) then 
...
database:srem(bot_id..'VlVlVI:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:HaDr:2',msg.sender_user_id_) then
database:srem(bot_id..'VlVlVI:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == 'اضف رد للكل' and DevHaDr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevHaDr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n↪️꒐ ارسل الكلمه تريد وضعها')
database:set(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:DriVeR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:DriVeR:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DriVeR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"🚮꒐ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:DriVeR:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:DriVeR:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:DriVeR:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:DriVeR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:DriVeR:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:DriVeR:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:DriVeR:List:Rd:Sudo")
end
...
database:set(bot_id.."Vc33h:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✅꒐ تم تفعيل الانستا')
database:set(bot_id.."Vc33h:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Vc33h:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Vc33h:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✅꒐ تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Vc33h:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Vc33h:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:DriVeR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"↪️꒐ ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:DriVeR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DriVeR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DriVeR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:DriVeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:DriVeR:Add:Rd:Sudo:Text2"..text)   
...
if text == 'تفعيل المغادره' and DevHaDr(msg) then   
...
if text == 'تعطيل المغادره' and DevHaDr(msg) then  
...
local HaDr = '🚻꒐ عدد الادمنيه : '..data.administrator_count_..
'\n\n🚯꒐ عدد المطرودين : '..data.kicked_count_..
'\n\n👥꒐ عدد الاعضاء : '..data.member_count_..
'\n\n📩꒐ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n◀️꒐ اسم المجموعة : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, HaDr) 
end,nil)
end,nil)
end 
...
database:set(bot_id.." HaDr:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✅꒐ تم تفعيل الزخرفه')
database:set(bot_id.." HaDr:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.." HaDr:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ — — — — — — — — — ٴ\n🚹꒐ [𝘚𝘰𝘳𝘶𝘤𝘦 𝘋𝘳𝘪𝘷𝘦𝘳 . ](t.me/Vc33h) ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '❎꒐ تم تعطيل الابراج')
database:set(bot_id.." HaDr:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✅꒐ تم تفعيل الابراج')
database:set(bot_id.." HaDr:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." HaDr:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." HaDr:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✅꒐ تم تفعيل حساب العمر')
database:set(bot_id.." HaDr:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." HaDr:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."HaDr:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'✅꒐ تم تفعيل الافلام')
database:set(bot_id.."HaDr:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."HaDr:movie_bot"..msg.chat_id_) == "open" then
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,HaDr,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (HaDr.total_count_ or 0)
...
local rdphoto = HaDra[math.random(#HaDra)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, HaDr.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, HaDr.photos_[0].sizes_[1].photo_.persistent_id_,'  🌁꒐ التعليق : '..rdphoto..'\n🏷꒐ ايديك : '..msg.sender_user_id_..'\n🚹꒐ يوزرك : '..username..'\n⏏️꒐ موقعك : '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n💭꒐ رسائلك : '..Msguser..'\n📊꒐ تفاعلك : '..Total_Msg(Msguser)..'\n🗯️꒐ سحكاتك : '..edit..'\n🏆꒐ نقاطك : '..NUMPGAME..'\n⎯ ⎯ ⎯ ⎯')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n🏷꒐ ايديك : '..msg.sender_user_id_..'\n🚹꒐ يوزرك : '..username..'\n⏏️꒐ موقعك : '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n💭꒐ رسائلك : '..Msguser..'\n📊꒐ تفاعلك : '..Total_Msg(Msguser)..'\n🗯️꒐ سحكاتك : '..edit..'\n🏆꒐ نقاطك : '..NUMPGAME..']\n⎯ ⎯ ⎯ ⎯')
else
...
if text == "تنظيف المشتركين" and DevHaDr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات" and DevHaDr(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-- vardump(data) 
DriVeRdx(msg.chat_id_, msg.id_, '🎟️꒐ ايدي المجموعة -› ( '..msg.chat_id_..' )\n🚻꒐ عدد الادمنيه -› ( *'..data.administrator_count_..' )*\n🚯꒐ عدد المحظورين -› ( *'..data.kicked_count_..' )*\n👤꒐ عدد الاعضاء -› ( *'..data.member_count_..' )*\n', 'md') 
end 
...
HaDr = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,HaDr)  
...
HaDr = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,HaDr)  
...
if text == 'استعاده الاوامر' and DevHaDr(msg) then
...
local Text =[[
*اهلا بك في سورس* [. DRIVER](t.me/Vc33h)
...
keyboard.inline_keyboard = {
{
{text = '-›› '..sendnum..'%',url="https://t.me/Vc33h"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '-›› '..sendnuj..'%',url="https://t.me/Vc33h"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnmj..' ‹‹-',url="https://t.me/Vc33h"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnuk..' ‹‹-',url="https://t.me/Vc33h"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '-›› '..sendnnk..'%',url="https://t.me/Vc33h"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨꒐ 𝘚𝘰𝘳𝘶𝘤𝘦 𝘋𝘳𝘪𝘷𝘦𝘳.',url="t.me/Vc33h"}},
}
local msg_id = msg.id_/2097152/0.5
...
DriVeR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DriVeR)
...
--------------------------------------------------------------------------------------------------------------
SourceDriVeR(data.message_,data)
plugin_DriVeR(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local DriVeRAbot = database:get(bot_id.."DriVeR1:Add:Filter:Rp2"..text..result.chat_id_)   
if DriVeRAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"🚹꒐ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n▶️꒐ ["..DriVeRAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local DriVeR1_Msg = database:get(bot_id.."DriVeR1:Add:Filter:Rp2"..text..result.chat_id_)   
if DriVeR1_Msg then    
send(msg.chat_id_, msg.id_,"🚹꒐ "..DriVeR1_Msg)
...
end -- end new msg dev.mr HaDr 
end -- end callback dev.mr HaDr
